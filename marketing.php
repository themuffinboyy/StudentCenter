    ...
    <section id="marketing_page">
      ...
      <div class="row">
        <div class="large-4 columns">
          <div class="label">Digital Signage</div>

          <div class="panel">
            <p>All officially recognized student organizations and University departments & offices are permitted to display
            content on the Digital Signage System.</p>
        ...
        <div class="large-4 columns">
          <div class="label">Bulletin Board</div>

          <div class="panel">
            <p>Bunch of bulletin board text.</p>
          </div>
        </div>

        <div class="large-4 columns">
          <div class="label">Posting Strips</div>

          <div class="panel">
            <p>Bunch of posting strips text.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="large-4 columns">
          ...
          <div class="panel">
            <p>Bunch of banner text.</p>
          </div>
        </div>

        <div class="large-4 columns">
          <div class="label">Signage in the Building</div>
          <div class="panel">
            <p>Bunch of signage in the building text.</p>
          </div>
        </div>
        ...
        <div class="large-4 columns">
          ...
          <div class="panel">
            <p>Bunch of questions that are asked frequently.</p>
          </div>
        </div>
      </div>
