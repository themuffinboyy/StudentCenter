...
<section id="mission_page">
    <div class="row mission_header">
      ...
      <div class="large-8 medium-8 banner columns">
        <img class="banner" src="images/mission/mission_banner.png">
      </div>
    </div>
    	...
    	<div class="small-12 medium-12 large-4 columns">
    		...
    		<div class="row nested">
    			<div class="large-12 columns end">
    				<div class="panel">Everyone who walks through the doors of the Chamberlain 
    				Student Center will experience the best services, programs and staff while 
    				developing a lifelong connection to the University.</div>
    			</div>
    		</div>
	    </div>
