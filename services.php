    ...
    <section id="services_page">
      ...
      <div class="row">
        <div class="large-4 columns">
          <a href="info.php"><div class="label">Info Desk</div></a>

          <div class="panel">
            <p>Bunch of info desk text.</p>
          </div>
        </div>

        <div class="large-4 columns">
          <a href="profs.php"><div class="label">Profs Place</div></a>

          <div class="panel">
            <p>Bunch of profs place text.</p>
          </div>
        </div>

        <div class="large-4 columns">
          <a href="gameroom.php"><div class="label">Gameroom</div></a>

          <div class="panel">
            <p>Bunch of gameroom text.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="large-4 columns">
          <a href="marketing.php"><div class="label">Marketing</div></a>

          <div class="panel">
            <p>Bunch of marketing text.</p>
          </div>
        </div>

        <div class="large-4 columns end">
          <a href="laundry.php"><div class="label">Laundry</div></a>
          
          <div class="panel">
            <p>Bunch of laundry text.</p>
          </div>
        </div>
      </div>
