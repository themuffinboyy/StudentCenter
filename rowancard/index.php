...
<body>
  ...
  <section id="rowancard_page">
    <div class="row card_header">
     ...
     <div class="row">
      ...
      <div class="large-4 columns end">
        <a href="merchants.php" class="button">Merchants</a>
      </div>
    </div>
    <div class="row">
      <div class="large-4 columns push_right">
      ...
      <div class="large-4 columns push_right">
        <a href="about.html" class="button" target="_blank">About the Card</a>
      </div>
      <div class="large-4 columns end">
    ...
    <div class="row">
      <div class="large-4 columns push_right">
        <a href="../faqs.php" class="button">FAQs</a>
      </div>
      <div class="large-4 columns push_right">
        <a href="#" class="button">Become a merchant</a>
      </div>
      <div class="large-4 columns end">
        <a href="account.html" class="button" target="_blank">Account info</a>
      </div>
    </div>
